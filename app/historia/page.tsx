      ...
      <section className="pt-48 pb-40 px-6 md:px-12">
        <div className="max-w-5xl mx-auto">
          <div className="mb-32 text-center">
            ...
            <h1 className="text-6xl md:text-9xl font-display leading-none tracking-tighter mb-12">EL CAMINO</h1>
            ...
            {milestones.map((item, i) => (
              ...
              >
                ...
                <div className="flex-1 space-y-8">
                  ...
                  <h2 className="text-3xl md:text-4xl font-display tracking-tight">{item.title}</h2>
          ...
          <div className="mt-48 p-20 border border-black/10 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-4xl md:text-6xl font-display mb-8 tracking-tighter">¿QUÉ SIGUE?</h2>
              <p className="text-xl font-serif italic text-black/60 mb-12 max-w-xl mx-auto">
                &quot;El camino nunca termina. Siempre hay una montaña más, una historia por descubrir y una trocha que nos espera.&quot;
              </p>
              <Link 
                href="/videos"
